 ...
 */
public class FilePathChangeCommandParser implements Parser<FilePathChangeCommand> {
     ...
     */
    public FilePathChangeCommand parse(String args) throws ParseException {
        ...
        return new FilePathChangeCommand(newPath);
    }
